//this has to be rebuilt to get this working, most of components used on mybid are in a shape
//of index.js as part of the folder which is actual name of component, make sure if that
// was not the actual way which should have been to use component 
